...
public class StreamQArrayTest {
    ...
    public void shouldNotReadWholeStreamWithDefault() {
        final Queue<String> queue = new ArrayBlockingQueue<>(100);
    ...
    public void shouldCreateLinkedQueue() {
        ...
        assertThat(queue, Matchers.instanceOf(ArrayMarkedQueue.class));
    }
    ...
    public void testReadingQueue() {
        ...
        assertThat(collected, hasItems("0", "1", "2", "3", "4"));
    }
    ...
    public void testIteratingOver() {
        ...
        assertThat(result, hasItems("0", "1", "2", "3", "4"));
    }
    ...
    private MarkedQueue<String> getQueue() {
        return MarkedQ.withMarker("").array().build();
    }
